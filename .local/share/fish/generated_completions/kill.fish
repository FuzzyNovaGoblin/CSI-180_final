...
complete -c kill -s q -l queue --description 'Use  sigqueue (3) rather than  kill (2).'
complete -c kill -l timeout --description 'Send a signal defined the usual way to a process.'
